                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-12 p-0">
                            <input type="text" class="form-control search-slt" placeholder="Enter Market Name" name="search" required>
                        </div>
...
try{ 
	...
	String sql ="SELECT * FROM DailyPrice where MarketName = '"+request.getParameter("search")+"'";
 ...
 <div class="">
  ...
  <p>Market Name:<%=request.getParameter("search")%></p>  
</div>            
