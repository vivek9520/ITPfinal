    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <label for="name">Tools:</label>
       <textarea  class="form-control"  name="tools" rows="7"  min="1" max= "500"  > <%=resultSet.getString("tools") %> </textarea>   
    	</div> 
    
      <div class="form-group">
      <label for="name">Steps:</label>
      <textarea  class="form-control"  name="steps" rows="7"  min="1" max= "500"  > <%=resultSet.getString("steps") %> </textarea>
